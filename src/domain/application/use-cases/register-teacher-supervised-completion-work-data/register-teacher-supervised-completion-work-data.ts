...
interface RegisterTeacherSupervisedCompletionWorkDataUseCaseRequest {
...
type RegisterTeacherSupervisedCompletionWorkDataUseCaseResponse = Either<
  TeacherSupervisedCompletionWorkDataAlreadyExistsError | ResourceNotFoundError,
  {
...
@Injectable()
export class RegisterTeacherSupervisedCompletionWorkDataUseCase {
  constructor(
  ...
  async execute({
    ...
    sessionUser,
  }: RegisterTeacherSupervisedCompletionWorkDataUseCaseRequest): Promise<RegisterTeacherSupervisedCompletionWorkDataUseCaseResponse> {
